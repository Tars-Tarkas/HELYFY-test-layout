let changetext=document.getElementsByClassName("moretext-btn");for(var i=0;i<changetext.length;i++)changetext[i].addEventListener("click",changeClassOne,!1);function changeClassOne(){document.getElementById("about-text-1").style.cssText="-webkit-line-clamp: 100"}function changeClassTwo(){document.getElementById("about-text-2").style.cssText="-webkit-line-clamp: 100"}
window.onload=function(){let e=document.getElementsByClassName("photo-gallery photo-hidden"),t=document.getElementById("photo-gallery-btn");for(let t=8;t<e.length;t++)e[t].style.display="none";let l=8;t.addEventListener("click",(function(){if(l<e.length){l=e.length;for(let t=0;t<l;t++)e[t].style.display="block"}}))};let playBnt=document.getElementById("playBtn");playBnt.addEventListener("click",(function(){let e=document.getElementById("Yplayer"),t=document.getElementById("video-preview");document.getElementById("player-block").style.display="block",t.style.display="none",playBnt.style.display="none",e.setAttribute("src","https://www.youtube.com/embed/UALhvLWsdZE?autoplay=1")}));
...
document.getElementById("modal-checkbox").addEventListener("change",(function(e){document.getElementById("modalBtn").disabled=!e.target.checked}));let btnBooking=document.getElementById("btnBooking"),closeModal=document.getElementById("closeBtn"),overlay=document.querySelector("#modalOverlay");btnBooking.addEventListener("click",(function(){document.querySelector(".modal").classList.add("active"),document.querySelector(".modal-overlay").classList.add("active")})),closeModal.addEventListener("click",(function(){document.querySelector(".modal.active").classList.remove("active"),document.querySelector(".modal-overlay.active").classList.remove("active")})),document.body.addEventListener("keyup",(function(e){27==e.keyCode&&(document.querySelector(".modal.active").classList.remove("active"),document.querySelector(".modal-overlay.active").classList.remove("active"))}),!1),overlay.addEventListener("click",(function(){document.querySelector(".modal.active").classList.remove("active"),this.classList.remove("active")}));
ymaps.ready((function(){var e=new ymaps.Map("y-map",{center:[55.758777,37.617698],zoom:15}),a=new ymaps.Placemark([55.758777,37.617698],{balloonContentHeader:"Встречаемся тут"},{preset:"islands#redDotIcon"});e.geoObjects.add(a),e.geoObjects.events.add("click",(function(e){let a=document.querySelector(".map-block-card");e.target?a.style.display="none":a.style.display="block"}))}));
new AirDatepicker(".datepicker",{dateFormat:"EEEE MMMM",inline:!1,autoClose:!0,dateFormat:t=>t.toLocaleString("ru",{day:"2-digit",month:"long",weekday:"long"}),position:"bottom right"});
let countReviews=document.querySelectorAll(".reviews-block-contetns"),countBtn=document.getElementById("showmoreTotal"),count=countReviews.length;countBtn.innerHTML="Показать Все ("+count+")";

$(".input-card-num").mask("9999 9999 9999 9999"),$(".input-card-data").mask("99/99"),$(".input-card-cvv").mask("999");
$(".input-data").mask("99.99.9999"),new AirDatepicker(".input-data",{dateFormat:"EEEE MMMM",inline:!1,autoClose:!0,dateFormat:t=>t.toLocaleString("ru",{day:"2-digit",month:"2-digit",year:"numeric"}),position:"bottom right"});
